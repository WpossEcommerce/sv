...
const PRIVATE_STORAGE = "/home/usuario-maquin/Projects/medianet/plataforma_medianet/private/";
const MEDIANET_ENDPOINT = "http://127.0.0.1:7020";//http://localhost:8080/ganicu/txn - http://192.168.1.10:7020/ganicu/txn
const CYRBERSOURCE_ENDPOINT = "http://127.0.0.1:8011/"; //http://localhost:8011/
const DEBIT_WS = "";
const TOKEN_WS = "";
